# APP_CODE_SNAPSHOT - the whole app as text
...
Files: 60   Total: 547,471 bytes (534.6 KB)
...
# Literal Windows drive-path folders (E:\data\...) created by mis-configured
# absolute paths when the app runs on Linux - never track these.
[A-Z]:*
...
```json
{
  "title": "Genessis on Chromebook",
  "subtitle": "This is a platform to test, create, and experiment with AI agents."
}
```
...
```json
{
  ...
  "dataDir": "/home/goofy/data",
  "dataDirLinux": "/home/goofy/data",
  "ragDbPath": "/home/goofy/data/db",
  "ragDbPathLinux": "/home/goofy/data/db",
  "rag": {
    "commitOnSave": false,
    "autoIngest": true
  },
  "chatSavePath": "/home/goofy/data/chat_log",
  "chatSavePathLinux": "/home/goofy/data/chat_log",
  "observe": {
    "terminal": true,
    "tools": false,
    "messages": false,
...
## docs/documentation_CREATING_AGENTS.md
````markdown
# Creating Agents
